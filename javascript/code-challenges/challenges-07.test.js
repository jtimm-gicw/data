...
const sortNumbers = (arr) => {
  return arr.sort((a,b) => a-b); // a is smaller than b
};
...
const sortBackwards = (arr) => {
  return arr.sort((a,b) => b-a); // b is the largest number
};
...
const alphabetize = (arr) => {
  return arr.sort(); // keep like this because the arry is already sorted array
};
