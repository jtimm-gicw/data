...
const addPeople = (arr) => {
  ...
  // Add 'Odie' to the beginning and 'Garfield' to the end using spread
  newPeople = ['Odie', ...newPeople, 'Garfield'];
...
const setState = (arr, obj) => {
  return {
    people: [...arr], // Creates a copy of the array
    stuff: {...obj} // Creates a copy of the object
};
};

const aNewState = setState(people, stuff);
console.log(aNewState);
...
const newState = (arr, obj) => {
  return {
    people: [...arr], // Copy of people array
    stuff: {
      ...obj, // Copy of the stuff object
      cars: [...obj.cars, "Ford"], // Copy cars array and add "Ford"
      toothbrush: "brand new", // Update toothbrush
      toys: obj.toys + 1 // Increase toys count
    }
  };
};
